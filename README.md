...
* [Overview of the Cluster](#overview-of-the-cluster)
    * [Authentication](#authentication)
    * [Monitoring/Alerting](#monitoringalerting)
        * [Metrics](#metrics)
        * [Dashboards](#dashboards)
        * [Blackbox Probes](#blackbox-probes)
        * [Alerts](#alerts)
* [Adding/Editing Deployments](#addingediting-deployments)
    * [Adding Helm Charts](#adding-helm-charts)
* [Progressive Delivery](#progressive-delivery)
    * [Smoke/Conformance Tests](#smokeconformance-tests)
    * [Gotchas](#gotchas)
* [Useful commands for admins](#useful-commands-for-admins)
    * [Observing flux state](#observing-flux-state)
    * [Debugging](#debugging)
    * [helm-operator can’t upgrade due to failed helm state](#helm-operator-cant-upgrade-due-to-failed-helm-state)
    * [Sniffing packets](#sniffing-packets)
* [Bootstrapping the cluster to use flux](#bootstrapping-the-cluster-to-use-flux)
...
[oauth2 proxy](https://oauth2-proxy.github.io/oauth2-proxy/) available
to protect services without their own login. Provides access to all
members of elifesciences Github organisation.
...
-   Prometheus will start probing the the host-paths found in the
    ingress
